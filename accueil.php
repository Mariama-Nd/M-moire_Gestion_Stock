...
<head>
 ...
 <link rel="stylesheet" href="assets/style/style.css">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                <div class="aside-logo flex-column-auto " id="kt_aside_logo">
                    <!-- <a href="caisse-paiement-cmjlf">
                        <img alt="Logo" src="assets/images/cmjlf.jpeg" class="h-60px logo " style="margin-left: 70px!important; margin-top: 5px;" />
                    </a> -->
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="accueil.php" class="d-lg-none">
                                <img alt="Logo" src="<?php echo htmlspecialchars($_SESSION['photoEcole']); ?>" class="h-30px" />
                            </a>
                        </div>
    ...
    <div class="flex-grow-1">
        ...
        <div class="row g-10">
            <div class="col-lg-3 col-sm-6 wow fadeInUp column-bg " data-wow-delay="0.1s">
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp column-bg" data-wow-delay="0.3s">
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp column-bg" data-wow-delay="0.5s">
                <a class="cat-item rounded p-4" href="Fournisseur/liste.php">
                    ...
                    <h6 class="mb-3">Liste des Fournisseurs</h6>
                        ...
                        <div class="col-lg-3 col-sm-6 wow fadeInUp column-bg" data-wow-delay="0.1s">
                <a class="cat-item rounded p-4" href="Gestion_example2/expressionBesoin/Liste_EB.php">
                    <i class="fa fa-3x fa-clipboard-list text-primary mb-4"></i>
                    <h6 class="mb-3">Expression besoin</h6>
                </a>
            </div>
        </div>
    </div>
