                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title" >Expression de besoins</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion " kt-hidden-height="507" >
                                    <div class="">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion " kt-hidden-height="507">
                                    <div class="">
                                        <a class="menu-link" href="../../Fournisseur/liste.php">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
...
<div id="modalBC" class="d-none"  class="modal">
    <div id="productModal">
        <div class="modal-content">
            ...
            <!-- Formulaire -->
             <div class="card-body">
             <form id="formBC" class="p-4 border rounded shadow bg-light">
    <h4 class="text-center mb-4">Nouvelle Commande</h4>

    <!-- Ligne 1 : Nom de la commande et Fournisseurs -->
    <div class="row mb-3">
        <div class="col-md-6">
            <label for="commandeNom" class="form-label fw-bold">Nom de la commande :</label>
            <input type="text" id="commandeNom" name="commandeNom" class="form-control" required />
        </div>
        <div class="col-md-6">
            <label for="fournisseurs" class="form-label fw-bold">Fournisseurs :</label>
            <select id="fournisseurs" name="fournisseurs[]" class="form-select select2" multiple>
                <!-- Fournisseurs ajoutés dynamiquement -->
            </select>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modeReglement" value="Liquide" id="reglementLiquide" required>
                <label class="form-check-label" for="reglementLiquide">Liquide</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modeReglement" value="Chèque" id="reglementCheque" required>
                <label class="form-check-label" for="reglementCheque">Chèque</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modeReglement" value="Virement bancaire" id="reglementVirement" required>
                <label class="form-check-label" for="reglementVirement">Virement bancaire</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modeReglement" value="Wave" id="reglementWave">
                <label class="form-check-label" for="reglementWave">Wave</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modeReglement" value="Orange Money" id="reglementOM">
                <label class="form-check-label" for="reglementOM">Orange Money</label>
            </div>
        </div>

        <!-- Modalité de paiement -->
        <div class="col-md-6">
            <label class="fw-bold">Modalité de paiement :</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modalitePaiement" value="Comptant à la livraison" id="paiementLivraison" required>
                <label class="form-check-label" for="paiementLivraison">Comptant à la livraison</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modalitePaiement" value="Comptant avant livraison" id="paiementAvantLivraison" required>
                <label class="form-check-label" for="paiementAvantLivraison">Comptant avant livraison</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modalitePaiement" value="Par tranche" id="paiementTranche" required>
                <label class="form-check-label" for="paiementTranche">Par tranche</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="modalitePaiement" value="50%" id="paiement50">
                <label class="form-check-label" for="paiement50">50%</label>
            </div>
        </div>
    </div>
    ...
    <div class="text-center mt-4">
        ...
        <button type="button" id="cancelBtn" class="btn btn-secondary px-4">Annuler</button>
    </div>
</form>
...
<script src="../../js/nouvelleCommande.js"></script>
<script>
