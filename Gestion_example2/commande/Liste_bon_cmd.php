...
<div class="button-container">
    <button id="openModalBtn" onclick="creerBC()">Nouvelle Commande</button>

</div>
  <!-- Bouton pour ouvrir la modal -->

<div class="modal d-none" id="fournisseurModal">
    <div class="modal-content">
        <h4>Choisir ou Ajouter un Fournisseur</h4>
        <form id="fournisseurForm">
    <label for="fournisseurSelect">Choisissez un fournisseur</label>
    <select id="fournisseurSelect" class="form-select" name="fournisseurSelect">
        <!-- Options des fournisseurs seront chargées ici -->
    </select>
    <button type="button" id="btnAjouterFournisseur">Ajouter un nouveau fournisseur</button>

    <div id="newFournisseur" style="display:none;">
        ...
        <button type="button" id="submitFournisseurBtn">Ajouter</button>
    </div>
...
<!-- <div id="modalBC" class="d-none">
    ...
    <!-- <div id="productModal" class="modal">
        <div class="modal-content"> -->
            ...
            <!-- <form id="formBC">
                <div>
                    <label for="commandeNom">Nom de la commande :</label>
                    <input type="text" id="commandeNom" name="commandeNom" required />
                </div>
                <div>
                    <label for="fournisseurs">Fournisseurs :</label>
                    <select id="fournisseurs" name="fournisseurs[]" multiple>
...
<table id="sales-table"  class="table align-middle table-row-dashed fs-6 gy-5" style="background-color: white;">
    ...
    <script src="../../js/listeBonCommande.js"></script>
