...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px ">
    ...
    <div id="productsContainer">
        <div class="product-form">
            <h2>Bon de Commande : <span id="bonCommandeName"></span></h2>
            <h4>Produit 1</h4>

            <!-- Sélection Sous Catégorie & Produit -->
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="sousCategorie" class="form-label">Sous Catégorie</label>
                    <select class="form-select" id="sousCategorie" name="idSC">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" id="quantity" name="quantite[]" class="form-control" min="1" required>
                </div>
                <div class="col-md-6">
                    <label for="unite" class="form-label">Unité</label>
                    <input type="text" id="unite" name="unite[]" class="form-control" placeholder="pièce, boîte, carton" required>
                </div>
            </div>

            <!-- Bouton Enregistrer -->
            <div class="text-end">
                <button type="button" class="btn btn-success" onclick="partielle_Add(this)">Enregistrer</button>
            </div>
        </div>
    </div>

    <!-- Boutons Ajouter & Sauvegarder -->
    <div class="text-center mt-3">
        <button type="button" class="btn btn-primary" onclick="addProduct()">Plus</button>
        <button type="submit" class="btn btn-success" id="sauvegarder" name="sauvegarder">Sauvegarder</button>
    </div>
</form>
