...
<div class="col-sm-8 mx-auto mt-10 d-none" id="divAlert" name="divAlert">
    ...
    <button type="button" id="btnAjouterFournisseur"  class="btn btn-success ">Ajouter un nouveau fournisseur</button>
...
<div class="form-group">
    ...
    <input type="number" id="telephone" name="telephone" class="form-control">
        ...
        <button type="button" id="submitFournisseurBtn"  class="btn btn-success  d-none">Ajouter</button>
        <button type="submit"  class="btn btn-primary mt-4">Générer le Bon</button>
    </div>
