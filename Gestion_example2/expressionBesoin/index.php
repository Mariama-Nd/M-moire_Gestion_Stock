...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  ...
  <style>
        body {
            min-height: 100vh;
            display: flex;
            flex-direction: column; /* Permet d'afficher header, contenu, footer */
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px ">
    ...
    <div class="form-container">
        <div class="card shadow-lg p-4">
            <h5 class="text-center mb-4 ">Recherche d'Agent</h5>

            <!-- Champ de recherche -->
            <div class="input-group mb-3">
                <input type="number" class="form-control" id="matricule-input" placeholder="Matricule de l'agent" required />
                <button  onclick="appel()">🔍</button>
            </div>

            <!-- Section de validation (cachée par défaut) -->
            <div id="creation" class="text-center" hidden>
                <input type="text" class="form-control mb-3" id="service" readonly />
                <button class="btn btn-success w-100" onclick="valider()">Valider</button>
            </div>
        </div>
    </div>
</div>
...
<script src="../../js/indexEB.js"></script>
</body>
</html>