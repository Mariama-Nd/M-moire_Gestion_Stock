...
<div id="productModal" class="modal">
        <div class="modal-content">
            ...
            <form id="productForm" method="post" class="p-3">
    <div id="productsContainer">
        <div class="product-form border p-3 rounded shadow-sm mb-4">
            <h2 class="mb-3">Bon de Sortie : <span id="expression-besoin-name"></span></h2>
            <h4 class="mb-3">Produit 1</h4>

            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="sous-categorie" class="form-label">Sous Catégorie</label>
                    <select class="form-select" id="sous-categorie" name="idSC" required>
                        <option value="" selected>Sélectionnez une sous catégorie</option>
                    </select>
                </div>

                <div class="col-md-6">
                    <label for="produit0" class="form-label">Nom du produit</label>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <span class="fw-bold" id="stock"></span>
                </div>
            </div>

            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="quantiteInput0" class="form-label">Quantité</label>
                    <input type="number" class="form-control" id="quantiteInput0" name="quantite[]" min="1" required oninput="checkQuantity(0,0)">
                </div>

                <div class="col-md-6">
                    <label for="uniteInput0" class="form-label">Unité</label>
                    <input type="text" class="form-control" id="uniteInput0" name="unite[]" required>
                </div>
            </div>
            ...
            <div class="text-end">
                <button type="button" class="btn btn-info" id="boutton_partielle0" onclick="partielle_Add(this,<?= $_GET['idBon'] ?>)">Enregistrer</button>
            </div>
        </div>
    </div>

    <div class="text-center mb-3">
        <button type="button" class="btn btn-primary" onclick="addProduct()" id="plus">Ajouter un produit</button>
    </div>

    <div class="text-center">
        <button type="submit" class="btn btn-success" name="sauvegarder" id="sauvegarde">Sauvegarder</button>
    </div>
</form>
    ...
    <script src="../../js/ajoutProductEB.js"></script>
