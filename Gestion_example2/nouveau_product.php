...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px ">
  ...
  <form id="add-sale-form" method="post">
   ...
   <div class="d-flex justify-content-center">
    <div class="d-flex justify-content-center">
        <button id="btnAjout" name="ajouter" type="submit" class="btn btn-primary mx-2 d-none ">
            <span class="indicator-label">Valider</span>
            <span class="indicator-progress">
                Veuillez patienter... <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
            </span>
        </button>
        <button type="button" id="openModalButton" class="btn btn-primary mx-2">Ajout multiple</button>
    </div>
</div>
    ...
    <div id="productModal" class=" modal ">
      <div class="modal-content">
        ...
        <form id="productForm"  method="post">
          ...
          <div class="buttons">
            <button type="button" class="add-button mx-2 " onclick="addProduct()">Plus</button>
          </div>
<div class="justify-content-between">
<button id="btnAjoutMultiple" name="add" type="submit" class=" btn btn-primary  mx-2  d-none">
  ...
  <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <script src="../js/nouveauProduct.js"></script>
