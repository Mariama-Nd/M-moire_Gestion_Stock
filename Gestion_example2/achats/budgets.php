    ...
    />
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="container bg-white p-4 shadow rounded">
                    <div class="title-bar">
                        <h2>Budgets disponibles</h2>
                        <a href="liste_expressions.php" class="btn btn-retour">← Retour aux Expressions</a>
                    </div>

                    <table id="tableBudgets" class="table table-bordered table-striped">
                    ...
                    <!-- Modal Modification -->
                    <div class="modal fade" id="modalModifierBudget" tabindex="-1" aria-labelledby="modalModifierLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                    <form id="formModifierBudget">
                        <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="modalModifierLabel">Modifier le budget</h5>
                        ...
                        <div class="row">
                            ...
                            <label for="mod_annee" class="form-label">Année</label>
                            <input type="number" class="form-control" id="mod_annee" name="annee" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            <label for="mod_type_budget_id" class="form-label">Type de budget</label>
                            <select class="form-select" id="mod_type_budget_id" name="type_budget_id" required></select>
                            </div>
                            <div class="col-md-6 mb-3">
                            <label for="mod_montant" class="form-label">Montant total</label>
                            <input type="number" class="form-control" id="mod_montant" name="montant_total" step="0.01" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            <label for="mod_statut" class="form-label">Statut</label>
                            <input type="text" class="form-control" id="mod_statut" name="statut" required>
                            </div>
                        </div>
                        </div>
