...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px ">
    ...
    />
        ...
        <table id="tableExpressions" class="table table-bordered table-striped">
...
<!-- Modal Modifier Expression -->
<div class="modal fade" id="modalModifierExpression" tabindex="-1" aria-labelledby="modifierLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <form id="formModifierExpression">
        <div class="modal-header bg-warning text-white">
          <h5 class="modal-title" id="modifierLabel">Modifier une expression de besoin</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <input type="hidden" name="idEB" id="mod_idEB">
          ...
          <div class="mb-3">
            <label for="mod_structure" class="form-label">Structure</label>
            <input type="text" class="form-control" id="mod_structure" name="structure" required>
          </div>

          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="mod_nom" class="form-label">Nom</label>
              <input type="text" class="form-control" id="mod_nom" name="nom" required>
            </div>
            <div class="col-md-6 mb-3">
              <label for="mod_prenom" class="form-label">Prénom</label>
              <input type="text" class="form-control" id="mod_prenom" name="prenom" required>
            </div>
          </div>
        </div>
