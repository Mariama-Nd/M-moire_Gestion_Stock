...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px ">
    ...
    />
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <!-- content -->
                <div class="page-wrapper bg-gra-03 p-t-45 ">
                <div class="col-sm-12">
<div class="row">
<div class="col-sm-8 mx-auto mt-10 d-none" id="divAlert" name="divAlert">
                                            <div class="alert alert-dismissible bg-danger d-flex flex-column flex-sm-row p-5 ">
                                                ...
                                                <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                                                    <h4 class="mb-2 text-light">Alerte</h4>

                                                    <span id="labelAlert"></span>
                                                </div>
                                            </div>
    ...
    <div class="container py-5">
        <div class="card card-5">
            <div class="card-heading">
                <h2 class="title text-center">Ajout d'une Nouvelle Sous-Categorie</h2>
            </div>
            <div class="card-body">
                <form method="POST" id="formSousCategorie" name="formSousCategorie" >
                <div class="form-group">
                        <label for="categorie-name" class="form-label">Catégorie <span style="color:red">*</span></label>
                        <select class="form-select" id="categorie-name" name="categorie" aria-label="Sélectionnez une catégorie">
            <option value="">Sélectionnez une catégorie</option>
                    ...
                    <div class="form-group">
                        <label for="duree" class="form-label">Durée d'amortissement <span style="color:red">*</span></label>
                        <input type="text" class="form-control" id="duree" name="duree" >
                    </div>
                    <div class="text-center">
                    <button id="btnAjoutSousCategorie" name="add" type="submit" class=" btn btn-primary col-sm-12 py-2 mt-3">
...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <script src="../../js/ajoutSousCategorie.js"></script>
