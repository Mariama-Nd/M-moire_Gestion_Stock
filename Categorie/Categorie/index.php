...
<div class="col-sm-8 mx-auto mt-10 d-none" id="divAlert" name="divAlert">
    ...
    <div class="container">
        <div class="card card-5">
            <div class="card-heading">
                <h2 class="title text-center">Ajout d'une Nouvelle Categorie</h2>
            </div>
            <div class="card-body">
            <form id="formCategorie" name="formCategorie" method="POST">
    ...
    <div class="form-group">
        <label for="nomC" class="form-label">Durée d'amortissement<span style="color:red">*</span></label>
        <input type="text" class="form-control" id="duree" name="duree">
    </div>
    <div class="text-center">
        <button id="btnAjoutCategorie" name="add" type="submit" class="btn btn-primary col-sm-12 py-2 mt-3">
    ...
    <script src="../../js/ajoutCategorie.js"></script>
